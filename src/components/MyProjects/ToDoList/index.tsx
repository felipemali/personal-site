  ...
  return (
    ...
    >
      <div className="update-csv-text">
        <h2>Todo List</h2>
        <p>
          Desenvolvi uma aplicação web de lista de tarefas (Todo List) com foco
          em organização pessoal e colaboração entre usuários, utilizando
          ...
          foi hospedada na Vercel, assegurando performance e integração contínua
          com o ambiente de desenvolvimento. Ferramentas utilizadas:
      ...
      <a href="https://to-do-list-nextjs-lfi3.vercel.app/">
        ...
        <div className="update-csv-image">
          <img src={to_do} alt=" aplicativo lista de tarefas" />
        </div>
      </a>
    </motion.div>
  );
